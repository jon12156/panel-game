...
function BattleRoom:startMatch(stageId, seed, replayOfMatch)
  ...
  -- for touch android/iOS players load a different scene
  if (love.system.getOS() == "Android" or love.system.getOS() == "iOS" or DEBUG_ENABLED) and self.gameScene.name ~= "PuzzleGame" and
